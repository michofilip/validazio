...
object ValidatorSpec extends ZIOSpecDefault {
  override def spec: Spec[TestEnvironment & Scope, Any] = {
    ...
    suite("Validator")(
      suite("provides object function")(
        suite("'id' that")(
        ...
        suite("'notEmpty' that")(
          test("succeeds if value is not empty string") {
            ...
            for {
              res <- Validator.validateZIO(ValidationException.apply)("test").exit
            } yield assertTrue {
          ...
          test("fails if value is empty string") {
            ...
            for {
              res <- Validator.validateZIO(ValidationException.apply)("").exit
            } yield assertTrue {
        ...
        suite("'regExr' that")(
          test("succeeds if value is a string that satisfies regex") {
            ...
            for {
              res <- Validator.validateZIO(ValidationException.apply)("test1").exit
            } yield assertTrue {
